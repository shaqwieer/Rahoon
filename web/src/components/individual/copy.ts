...
const ar = {
  ...
  concern: {
    panelTitle: "هل هناك خطأ أو مشكلة؟",
    panelBody: "يمكنك الاعتراض على بيانات أو مبالغ أو قرار، أو تقديم شكوى على الخدمة. يراجعها فريق رهون ويرد عليك هنا.",
    objection: "اعتراض على بيانات أو مبالغ أو قرار",
    complaint: "تقديم شكوى",
    objectDecision: "الاعتراض على القرار",
    newForOtherFinance: "طلب لتمويل آخر",
    titleObjection: "اعتراض",
    titleComplaint: "شكوى",
    headingObjection: "على ماذا تعترض؟",
    headingComplaint: "ما شكواك؟",
    subject: "الموضوع",
    subjects: { data: "بيانات غير صحيحة", amount: "مبلغ غير صحيح", decision: "قرار على طلبي", service: "الخدمة أو التواصل", other: "أخرى" } as Record<string, string>,
    text: "اشرح ما حدث وما تراه صحيحاً",
    textError: "اكتب ما حدث وما تراه صحيحاً.",
    complaintNote: "يراجع شكواك عضو في فريق رهون غير المنسق المسؤول عن طلبك.",
    send: "إرسال",
    sentTitle: "وصل ما أرسلته",
    back: "العودة لطلبي",
    listTitle: "اعتراضاتك وشكاواك",
    open: "قيد المراجعة",
    answered: "تم الرد",
    outcomes: { upheld: "قُبل", not_upheld: "لم يُقبل", clarified: "توضيح" } as Record<string, string>,
    response: "رد فريق رهون",
    referralsTitle: "إحالة إلى مختص",
    docsTitle: "استكمال المستندات",
  },
  messages: {
    title: "الرسائل",
...
const en: RequestCopy = {
  ...
  concern: {
    panelTitle: "Is something wrong?",
    panelBody: "You can object to data, amounts or a decision, or complain about the service. The Rahoon team reviews it and answers here.",
    objection: "Object to data, amounts or a decision",
    complaint: "File a complaint",
    objectDecision: "Object to the decision",
    newForOtherFinance: "Request for another finance",
    titleObjection: "Objection",
    titleComplaint: "Complaint",
    headingObjection: "What are you objecting to?",
    headingComplaint: "What is your complaint?",
    subject: "Subject",
    subjects: { data: "Incorrect data", amount: "Incorrect amount", decision: "A decision on my request", service: "Service or communication", other: "Other" },
    text: "Explain what happened and what you believe is correct",
    textError: "Explain what happened and what you believe is correct.",
    complaintNote: "Your complaint is reviewed by a Rahoon team member other than your request's coordinator.",
    send: "Send",
    sentTitle: "We received it",
    back: "Back to my request",
    listTitle: "Your objections and complaints",
    open: "Under review",
    answered: "Answered",
    outcomes: { upheld: "Upheld", not_upheld: "Not upheld", clarified: "Clarified" },
    response: "Rahoon team's answer",
    referralsTitle: "Referral to a specialist",
    docsTitle: "Complete your documents",
  },
  messages: {
    title: "Messages",
