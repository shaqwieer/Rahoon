...
public sealed partial class DevSeeder
{
    private async Task SeedVoluntarySaleAsync()
    {
        ...
        {
            OrganizationId = org.Id, Reference = "ASG-2026-0873", CaseId = c2.Id, ProviderOrganizationId = _orgs["broker-a"].Id, AssigneeUserId = UserId("sami"),
        ...
        Audit(org.Id, c2, "sale.broker_assigned", "تكليف دار الوسطاء «أ» بوساطة البيع", At("2026-09-01T13:00:00"), "sara", detail: "ASG-2026-0873 · نطاق: ملف البيع فقط");
