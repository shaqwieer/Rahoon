...
public sealed partial class DevSeeder
{
    private async Task SeedCaseTabsAsync()
    {
        ...
        const string csv = """
            ...
            MF-90-1180092,سعود عبدالله القحطاني,1067890123,0551100236,عسير,أبها,حي المنسك,فيلا سكنية,760000.00,41000.00,7000.00,0.00,808000.00,36000.00,4,2027-01-01
